...
# with command line options: Configuration/GenProduction/python/BTV-RunIIFall17wmLHEGS-00005-fragment.py --fileout file:BTV-RunIIFall17wmLHEGS-00005.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename BTV-RunIIFall17wmLHEGS-00005_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(22) -n 2470
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BTV-RunIIFall17wmLHEGS-00005-fragment.py nevts:200'),
...
#        filterName = cms.untracked.string('')
#    ),
#    fileName = cms.untracked.string('file:EXOps-RunIIFall17wmLHEGS-00005_inLHE.root'),
