...
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/TopDMJets_scalar_tWChan_Mchi_1_Mphi_10_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_GENSIM/'
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_10_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/'
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_20_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/', 
'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_50_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/',
'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_200_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/',
'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_300_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/',
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_500_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/',
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TopDMJets_scalar_tWChan_Mchi_1_Mphi_1000_TuneCP5_13TeV_madgraphMLM_pythia8_RunIIFall17_PremixStep1/'
...
#                           #
###############           #
maxIdlingJobsAccepted = 3500 #600 #3000
maxcheckedFiles = 1000 
SplitSizeStepOfFileList = 1 #2 #10

OldDirectoriesSuffix = "PremixStep1" #"AODSIM" #"2018-MINIAODSIM" #"2018-AODSIM" #"PremixStep1" #"GENSIM"

NewDirectoriesSuffix = "AODSIM" #"PremixStep1"  #"2018-NANOAODSIM"
      #              ############
    #                           #
  #                  as needed  #
#                               #
...
#          getNumberOfRootFileInDirectoryNameOld = getNumberOfRootFileInDirectoryNameOld[-3]
          getNumberOfRootFileInDirectoryNameOld = subListIngetSlicedList.split("/")[-1].split('.')[0].split('_')[-1]
    #      print(getNumberOfRootFileInDirectoryNameOld)
          TemplateFileNameAdjusted = DirectoryName+"_"+str(getNumberOfRootFileInDirectoryNameOld)+"_cfg.py" #+templateFile
#         TemplateFileNameAdjusted = TemplateFileNameAdjusted.replace('EXO-RunIIFall17DRPremix-00062_step1_template_', '')
    ...
    #      sys.exit("Stopping test")          
      ...
      if os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile):
                               if os.path.exists(NewDirectoryPath+"/"+TemplateFileNameAdjusted):
                                   removePyfile = "rm "+NewDirectoryPath+"/"+TemplateFileNameAdjusted
                                   subprocess.Popen([removePyfile], shell=True,
                                             stdout=subprocess.PIPE).communicate()[0]

      if not os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile):
      ...
      if args.check:
          ...
          if os.path.exists(NewDirectoryPath+"/"+outputRootfile): # or os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile):
              ...
              if not jobInBatch:
                      ...
                      print(pycolors.green+"checkedFiles = "+str(checkedFiles)+pycolors.end)
                      if checkedFiles > maxcheckedFiles: sys.exit(pycolors.green+"Maximum of to be checked files reached. Stop running."+pycolors.end)
                      #sys.exit()
                      getNEventsTier2 = 0
...
#os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile): # or  os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+DirectoryName+"/"+outputRootfile):                                             
                               #with open(FilesToBeCopiedToPNFStxt, 'a') as fobj1:
                                #   fobj1.write("gfal-copy "+NewDirectoryPath+"/"+outputRootfile+" \'srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile+"\'"+"\n \n")
                               gfalCopyCommand = "gfal-copy "+NewDirectoryPath+"/"+outputRootfile+" \'srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile+"\'"
                               getgfalcommand = subprocess.Popen([gfalCopyCommand], shell=True,
                                             stdout=subprocess.PIPE).communicate()[0]
                               #sys.exit()
                               print(getgfalcommand)
                           #
                           if os.path.exists(NewDirectoryPath+"/"+outputRootfile) and os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile):
                               ...
                               getCleanupRootFilecommand = subprocess.Popen([CleanupRootFile], shell=True,
                                             stdout=subprocess.PIPE).communicate()[0] 
                               print(pycolors.green+CleanupRootFile+pycolors.end)
                           if os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+outputRootfile):
                               if os.path.exists(NewDirectoryPath+"/"+TemplateFileNameAdjusted):
