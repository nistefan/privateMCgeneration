...
#2018
#templateFile = 'EXO-RunIIAutumn18DRPremix-00004_template_cfg.py'
...
#pathArray =[
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TTbarDMJets_Dilepton_PS1_LO_Mchi-1_Mphi-100_TuneCP5_13TeV-madgraph-mcatnlo-pythia8-AODSIM/',
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TTbarDMJets_Dilepton_scalar_LO_Mchi-1_Mphi-100_TuneCP5_13TeV-madgraph-mcatnlo-pythia8-ext1-AODSIM/',
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TTbarDMJets_Dilepton_pseudoscalar_LO_Mchi-1_Mphi-100_TuneCP5_13TeV-madgraph-mcatnlo-pythia8-AODSIM/',
#'/pnfs/desy.de/cms/tier2/store/user/nstefano/2017/TTbarDMJets_Dilepton_scalar_LO_Mchi-1_Mphi-100_TuneCP5_13TeV-madgraph-mcatnlo-pythia8-AODSIM/'
...
for item_condor in ask_condor:
    if "Total for" in item_condor:
        getJobsOnCondorAtMoment = item_condor
        break
print(getJobsOnCondorAtMoment)
#getJobsOnCondorAtMoment = ask_condor[5].split(',')

getIdlingJobs = int((getJobsOnCondorAtMoment.split(',')[0]).split(' ')[3]) 
...
#                           #
###############           #
maxIdlingJobsAccepted = 2001 #600 #3000
...
tobeRemovedtxt ="tobeRemoved.txt"
...
#sys.exit()
CleanupAreatxt = "CleanupArea.txt"
CleanupAreapy = "CleanupAreapy.txt"
...
#    DirectoryName = pathsplit[-4]
 ...
 # getLineByLineCondor = getListOfCondor.split('\n')
  ...
  for subListIngetSlicedList in range(0, 5000): #getSlicedList:
...
#          getNumberOfRootFileInDirectoryNameOld = getNumberOfRootFileInDirectoryNameOld[-1].split(".")
          ...
          #if args.verbose: print(getNumberOfRootFileInDirectoryNameOld)                                                                                                                                                                                     
      TemplateFileNameAdjusted = templateFile.replace('template', str(subListIngetSlicedList))
...
#      else:
 #         TemplateFileNameAdjusted = DirectoryName+"_"+str(countTemplateFiles)+"_"+templateFile
      ...
      rootOutputFile = TemplateFileNameAdjusted[:-7]+".root"
        ...
        #if args.verbose:                                                                                                                                              
      if not os.path.exists(DirectoryName+"/"+str(subListIngetSlicedList)) and not os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+rootOutputFile):
...
#'/nfs/dust/cms/user/stefanon/DM_Sample_Production/DMsingleTop/DMScalar_top_tWChan_Mchi1_Mphi100_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'
#DirectoryName+"/"+str(subListIngetSlicedList)+)
...
# --- --- --- Decision about file's sanity according to  HTCondor output --- --- ---   
                      ...
                      if getNEventsTier2 == 200: 
                           ...
                           if os.path.exists(NewDirectoryPath+"/"+rootOutputFile) and os.path.exists("/pnfs/desy.de/cms/tier2/store/user/nstefano/"+ExtraDirectoryCreationOnPNFS+DirectoryName+"/"+rootOutputFile):
